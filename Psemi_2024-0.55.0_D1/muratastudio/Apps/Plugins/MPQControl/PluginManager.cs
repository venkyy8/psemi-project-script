...
namespace MpqControl
{
	...
	{
		private MpqControl _mpqControl;
		...
		{
			_mpqControl = new MpqControl(device, isInternalMode);
		...
		public PluginManager()
		{
			_info = new PluginInfo
			{
				...
				PanelName = "Device",
				ButtonName = "Device",
				ButtonImage = new BitmapImage(new Uri("/MpqControl;component/Images/Application32.png", UriKind.Relative)),
				ButtonSmallImage = new BitmapImage(new Uri("/MpqControl;component/Images/Application32.png", UriKind.Relative)),
				DockTabImage = new BitmapImage(new Uri("/MpqControl;component/Images/Application32.png", UriKind.Relative)),
